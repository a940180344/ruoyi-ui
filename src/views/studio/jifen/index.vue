<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="项目名" prop="xmuming">
        <el-input
          v-model="queryParams.xmuming"
          placeholder="请输入项目名"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['studio:jifen:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['studio:jifen:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="jifenList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="项目名" align="center" prop="xmuming" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="项目名" prop="xmuming">
          <el-input v-model="form.xmuming" placeholder="请输入项目名" />
        </el-form-item>
      </el-form>
  ...
  methods: {
    ...
    getList() {
      ...
      listJifen(this.queryParams).then(response => {
        ...
        this.loading = false;
        this.heji = 0
        for (const ad of this.jifenList) {
          this.heji += Number(ad.jifen)
        }
      });
    },
    // 取消按钮
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('studio/jifen/export', {
        ...this.queryParams
